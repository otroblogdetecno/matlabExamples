...
nombreImagenP='117.jpg';
 ...
 pathAplicacionAprender=strcat(pathPrincipal,'tmpToLearnManchas/');
...
%% Nombres de archivos 
 ...
 archivoVector=strcat(pathResultados,'aManchasCF.csv');
...
for n=1:size(listado)
    ...
    PrincipalProcesarImagenManchas( corrida, pathPrincipal, pathEntradaAprender, pathConfiguracion, pathAplicacionAprender, pathResultados, banderaCalibracion, banderaRotar, nombreImagenP, archivoConfiguracion, archivoCalibracion, archivoVector );
end %
