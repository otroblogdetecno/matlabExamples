...
clc; clear all; close all;
 ...
 pathResultados=strcat(pathPrincipal,'output/clasHSV/');
...
% nombreArchivoColorM='res_HSV_CF_M.csv';
% nombreArchivoColorNM='res_HSV_CF_NM.csv';

 
 nombreArchivoSetCompleto='aTSCompletoHSVCF.csv';
 
 %Leer las 
nombreArchivoTraining='aTrainingHSVCF.csv';
nombreArchivoTest='aTestHSVCF.csv';
nombreArchivoScreen='screenHSV.txt'; 
% 
...
fprintf('PRUEBA # %i \n',prueba);
fprintf('-----------------------------------\n');
dividirConjuntos( proporcionTraining, pathPrincipal, pathResultados, nombreArchivoSetCompleto, nombreArchivoTraining, nombreArchivoTest);
...
for indiceTest=1:size(arrayTest)
    ...
    %% Presentacion de Resultados        
        ...
        filaMatriz=1;
        columnaMatriz=1;
       %en las columnas lo que clasificó el software 
...
% en las filas lo que etiqueto el experto
