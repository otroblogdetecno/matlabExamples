...
%SE = strel('disk', 1);
SE = strel('diamon', 1);
IManchasFinalD= imdilate(IManchasFinal,SE);
imwrite(IManchasFinalD,nombreImagenDefectos,'jpg');

%figure('Name','Fill final');imshow(IManchasFinalD);

%BW5=imfill(IManchasFinal,'holes');
%figure('Name','Fill final');imshow(BW5);
