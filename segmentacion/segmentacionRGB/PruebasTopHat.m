...
J=imadjust(IGris);
J2 = imtophat(J, strel('disk', 10));

I2 = imtophat(IGris, strel('disk', 10));

figure('Name','Gris'); imshow(IGris);
figure('Name','Gris ajustado'); imshow(J);
figure('Name','Tophat Ajustado'); imshow(J2);
figure('Name','Tophat'); imshow(I2);
