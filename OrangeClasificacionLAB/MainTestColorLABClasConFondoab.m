...
%% Conjunto general de entrenamiento 
 nombreArchivoSetCompleto='aTSCompletoLABCF.csv';
 
 %Leer las 
 nombreArchivoTraining='aTrainingLABCF.csv';
 nombreArchivoTest='aTestLABCF.csv';
...
tablaDSTrainingCaracteristicas=tablaDSTraining(:,14:15);
...
% 13,14,15 corresponde a la etiqueta de L=13. *a=14, *b=15
tablaDSTestComparar=tablaDSTest(:,14:15);
