function [ output_args ] = guardarArchivoVector2( nombreArchivo, filaAgregar )
...
if (fileIDTest==-1)
    ...
    filaCabecera=sprintf('nombre_imagen, pixel_p, area_p, area_mm, redondez, diametro_p, diametro_mm, ejeMayor, ejeMenor, R, G, B, L1, A1, B1, varianzaH, clasificacion, clasificacionM');
