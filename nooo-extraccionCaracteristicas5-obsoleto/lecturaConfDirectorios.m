function [ resultado ] = lecturaConfDirectorios( etiquetaBuscar, archivoConfig)
% --------------------------------------------
%% Lectura de XML
%Valores a buscar en el XML

%etiquetaBuscar = 'Cuadro3_lineaGuiaInicialFila';
%etiquetaValor = '-1'; %default
