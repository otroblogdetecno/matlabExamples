function [ output_args ] = MainGetImageToProcess2()
%%getImageToProcess
...
%para inicializar el valor se le pone un nombre, pero se sobreescribe al
%tomar los datos desde un listado de archivos
...
for n=1:size(listado)
    ...
    PrincipalProcesarImagen2( corrida, pathPrincipal, pathEntradaAPredecir, pathConfiguracion, pathAplicacionPrediccion, pathResultados, banderaCalibracion, banderaRotar, nombreImagenP, archivoConfiguracion, archivoCalibracion, archivoVector );
end %
