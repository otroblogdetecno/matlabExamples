...
if (fileIDTest==-1)
    ...
    filaCabecera=sprintf('nombre_imagen, pixel_p, area_p, area_mm, redondez, diametro_p, diametro_mm, ejeMayor, ejeMenor, R, G, B, H, S, V, varianzaH, clasificacion, clasificacionM');
